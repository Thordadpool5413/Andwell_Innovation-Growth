import { Competitor, ServiceLine, Evidence, Battlecard, Report, MaineCounty, CountyDemand, GrowthScenario, LaunchPlanStep, CatalogItem } from "./types"
...
export const mockCompetitors: Competitor[] = [
  { id: "c1", name: "Northern Light Home Care", website: "https://northernlighthealth.org", url: "https://northernlighthealth.org/home-care", lastScraped: "2026-05-19", status: "complete", mainePresence: "yes", maineCounties: ["Penobscot", "Aroostook", "Hancock", "Washington"] },
  { id: "c2", name: "MaineHealth Home Health", website: "https://mainehealth.org", url: "https://mainehealth.org/services/home-health", lastScraped: "2026-05-19", status: "complete", mainePresence: "yes", maineCounties: ["Cumberland", "York", "Lincoln", "Sagadahoc", "Knox", "Waldo"] },
  { id: "c3", name: "Gentiva", website: "https://gentiva.com", url: "https://gentiva.com/locations/maine", lastScraped: "2026-05-18", status: "complete", mainePresence: "yes", maineCounties: ["Cumberland", "York", "Androscoggin"] },
  { id: "c4", name: "Amedisys", website: "https://amedisys.com", url: "https://amedisys.com/locations/maine", lastScraped: "2026-05-18", status: "complete", mainePresence: "yes", maineCounties: ["Kennebec", "Androscoggin", "Oxford", "Franklin"] },
  { id: "c5", name: "Interim HealthCare", website: "https://interimhealthcare.com", url: "https://interimhealthcare.com/locations/maine", lastScraped: "2026-05-17", status: "complete", mainePresence: "yes", maineCounties: ["Cumberland", "York"] },
  { id: "c6", name: "VNA Home Health", website: "https://vna.org", url: "https://vna.org/maine", lastScraped: "2026-05-16", status: "complete", mainePresence: "yes", maineCounties: ["Cumberland", "York", "Sagadahoc", "Lincoln"] },
]

export const mockEvidence: Evidence[] = [
  { id: "e1", competitorId: "c1", source: "Northern Light Annual Report", snippet: "Northern Light Home Care expanded telehealth monitoring for 1,200+ patients across Penobscot and Aroostook counties in 2025", date: "2026-03-20", relevance: 9, maineRelevance: true },
  { id: "e2", competitorId: "c1", source: "Press Release", snippet: "Northern Light Health opened new home health hub in Bangor serving 7 rural counties", date: "2026-02-10", relevance: 8, maineRelevance: true },
  { id: "e3", competitorId: "c2", source: "MaineHealth Website", snippet: "MaineHealth Home Health reports 15% growth in skilled nursing visits across Cumberland and York counties", date: "2026-04-05", relevance: 8, maineRelevance: true },
  { id: "e4", competitorId: "c2", source: "DHHS Filing", snippet: "MaineHealth received certificate of need for expanded home health services in Lincoln and Knox counties", date: "2026-01-28", relevance: 9, maineRelevance: true },
  { id: "e5", competitorId: "c3", source: "Gentiva Corporate", snippet: "Gentiva added wound care certified nurses to their Portland and Lewiston offices targeting chronic wound patients", date: "2026-04-15", relevance: 7, maineRelevance: true },
  { id: "e6", competitorId: "c3", source: "Press Release", snippet: "Gentiva Maine operations restructured under new regional director for Northern New England", date: "2026-03-01", relevance: 6, maineRelevance: true },
  { id: "e7", competitorId: "c4", source: "Amedisys Investor Day", snippet: "Amedisys identified Maine as a 'key expansion state' for 2026 with focus on Kennebec and Androscoggin counties", date: "2026-05-01", relevance: 10, maineRelevance: true },
  { id: "e8", competitorId: "c4", source: "Press Release", snippet: "Amedisys partnering with MaineGeneral Health for post-acute care transitions in Augusta region", date: "2026-04-20", relevance: 9, maineRelevance: true },
  { id: "e9", competitorId: "c5", source: "Interim HealthCare News", snippet: "Interim HealthCare of Maine launched companion care program for seniors aging in place in Portland metro", date: "2026-02-22", relevance: 6, maineRelevance: true },
  { id: "e10", competitorId: "c6", source: "VNA Home Health Report", snippet: "VNA of Maine reports 98% patient satisfaction but struggles with rural coverage gaps in Washington County", date: "2026-03-15", relevance: 7, maineRelevance: true },
  { id: "e11", competitorId: "c1", source: "Maine DHHS Data", snippet: "Northern Light captured 22% of Maine's home health Medicare referrals in 2025, highest in the state", date: "2026-04-01", relevance: 9, maineRelevance: true },
  { id: "e12", competitorId: "c2", source: "MaineHealth News", snippet: "MaineHealth launching home-based wound care pilot in 5 coastal counties starting Q3 2026", date: "2026-05-10", relevance: 9, maineRelevance: true },
  { id: "e13", competitorId: "c3", source: "CMS Data", snippet: "Gentiva's Maine patient outcomes score 3.8/5 stars vs 4.2/5 state average", date: "2026-04-28", relevance: 7, maineRelevance: true },
  { id: "e14", competitorId: "c4", source: "Amedisys SEC Filing", snippet: "Amedisys plans to hire 40+ clinical staff for Maine operations in 2026", date: "2026-05-05", relevance: 8, maineRelevance: true },
]
